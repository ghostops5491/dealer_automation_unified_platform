...
import { Clock, CheckCircle2, XCircle, Eye, User, ShieldCheck } from 'lucide-react';
...
interface SubmissionWithApprovalInfo extends FormSubmission {
  screensRequiringApproval?: ScreenApprovalInfo[];
}
    ...
    <div className="page-enter space-y-6">
      ...
      {submissions.length === 0 ? (
        <Card className="p-12 text-center">
          ...
          <p className="text-muted-foreground">No submissions waiting for approval</p>
        </Card>
      ) : (
          ...
          {submissions.map((submission: SubmissionWithApprovalInfo) => (
            <Card key={submission.id} className="hover:shadow-md transition-shadow">
              <CardContent className="p-6">
                ...
                {/* Screens requiring approval */}
                {submission.screensRequiringApproval && submission.screensRequiringApproval.length > 0 && (
                  <div className="mt-4 pt-4 border-t">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {submission.screensRequiringApproval.map((screen) => (
                        <Badge
                          key={screen.screenId}
                          variant="secondary"
